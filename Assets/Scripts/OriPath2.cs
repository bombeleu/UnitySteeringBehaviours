...
public class OriPath2{
	...
	public Vector3[] Route(){
		...
		PathMovement[2] = new Vector3(431.2926f, 235.571f, -1000.0f);
		PathMovement[3] = new Vector3(431.2926f, 235.571f, -1300.0f);
		PathMovement[4] = new Vector3(431.2926f, 235.571f, -1500.0f);
		return PathMovement;
	}
}